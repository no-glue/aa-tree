...
#include "decorator_dfs_max_depth.h"
...
int main() {
  ...
  DecoratorDfsMaxDepth * get_max_depth = new DecoratorDfsMaxDepth();
  DecoratorDfsMessage * dfs_message = new DecoratorDfsMessage();
  ...
  // todo move this to component
  tree->walk(not_seen);
  cout<<"network diameter: "<<importer->depth_first_search(tree, get_max_depth, max_depth, dfs_message)<<endl;
  // todo move this to component
